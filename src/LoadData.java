    ...
    public void search(String[] str) { 
        ...
        if (str.length == 0 && !iter.hasNext()) {
            ...
            if (str.length == 0) {
                ...
                date = str[0].substring(6) + str[0].substring(0,2) +  str[0].substring(3,5);
            }
            ...
            if (stateArr1[0] == null) {
                System.out.println("There are no records on " + str[0]);
            }
            else {
                int counter = 0;
            ...
            int param = Integer.valueOf(str[1]);
            
            int j = 0;
            while (j < NUMBER_OF_STATES) {
                if (state_abvs[j].equals(str[0])) {
                    isState = true;
                    break;
                }
                j++;
            ...
            if (param <= 0) {
                ...
                System.out.println("State of " + str[0] + " does not exist!");
            }
            else {
                ...
                while (iter.hasNext() && k < param) {
                    State state = iter.next(); 
                    if (state.getState().equals(str[0])) {
                        stateArr[k] = state;
                        k++;
                    }
                }
                if (k != 0) {
                    System.out.println(k + " records are printed out for the state of " + str[0]);
                    int count = 0;
                    ...
                    System.out.println("There are no records from " + str[0]);
                }
            }
        }
    }
